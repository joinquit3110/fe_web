...
export default function Buttons({
  ...
  failureMessage,
  successMessage,
  onSubmission // New prop for scoring callback
}) {
  ...
  const checkAnswers = () => {
    ...
    // Call the onSubmission callback with isCorrect and isFirstAttempt
    if (onSubmission) {
      const isFirstAttempt = trials === 0;
      onSubmission(isCorrect, isFirstAttempt);
    }
  };
...
Buttons.propTypes = {
  ...
  onSubmission: PropTypes.func // Add this prop type
};
